# 🖥 TERAMIND — the complete and FINAL record (subscription cancelled 2026-09-06)

> ⚠️ **CANCELLED 2026-09-06 09:40Z.** The Sep-5 digest was the last one. What is in this folder is now the *entire* surviving Teramind record for APW. The behind-login data — minute-level activity, sessions, keystrokes and **screen recordings** — was never exported before cancellation and is gone with the tenant. Nothing below can be re-pulled.
...
|---|---|---|
| [digests/DIGESTS_ALL.json](digests/DIGESTS_ALL.json) | every daily **Snapshot** digest: alerts, emails in/out per user, IM, printed, websites + minutes (top-3), activity % (headline + **top-3 leaderboard**, ruling #27), new users | **49 days** (Jul 7 → **Sep 5, final**) (no digest exists in Gmail for Jul 13–21, Aug 15, Aug 22–23) |
