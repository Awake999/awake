...
1. **Fathom** (`calls/fathom/INDEX.md`, 8/234 archived): continue Aug 20+ top-down — next up 802994217, 802985297, 801909953, then client-named calls (Yeshaya Dank 799338949, Chris Mclean 798638035, Todd LoGuidice 800283407, Nick Samara x2, Michael Moore x2…). Max ~3 transcripts per query round; large ones save to file — move into place.
2. **Krisp** (`calls/krisp/INDEX.md`, 5/~150 archived): next ★ SCIO Sales Consulting 6/16 (019ed1d72a0e73e8a08717617d8fedd6), 6/18, 6/23, 8/4; then the 8/28 day-capture (01a03ec7bda3775ca1cd835bf3717525 — Alan, Carla, Lynn, Constantine, Jacob); then client calls (Pedro triage, Leo 12k, Jill sessions).
