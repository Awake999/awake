# INDEX — clickable pointers to EVERYTHING, across every medium
*Every reference is a clickable URL (register #66 / CLICKABLE LAW). Raw IDs live only in `ops/data/pointer-map.md` under "for machines."*
...
| What | Open it |
|---|---|
| Clients & Leads — all 83, the edit surface | [open database](https://app.notion.com/p/a9adc601acc44b61b80f48969e764522) |
| Client Tracking Command Center (hub) | [open](https://app.notion.com/p/3b75bb1ffef48196aa4efcf029dc732d) |
| Client Document Dossiers | [open](https://app.notion.com/p/3b95bb1ffef481bf8a6ad869157d72e0) |
| ⚡ APW OPS HUB (top) | [open](https://app.notion.com/p/3ba5bb1ffef48182b54cde51f6da1ae2) |
| Master Ops Checklist (pre-register items) | [open](https://app.notion.com/p/43852d864f7b4977976d6be6a3ec1d30) |
| Ad Scoreboard (verified spend + library links) | [open](https://app.notion.com/p/412f6a46d3ba4b5daacec84d36499e51) |
| Call Library (146+) | [open](https://app.notion.com/p/4a3dd72b984f427e8b421c681a9873f0) |
| SOP Library (business SOPs) | [open](https://app.notion.com/p/a7475e83230a49f894467b1c742c446e) |

## Audits & evidence (every claim linked inside)
| What | Notion (read/annotate) | Vault (raw) |
|---|---|---|
| Booking Roster Audit (140 events, named) | [open](https://app.notion.com/p/3cc5bb1ffef481138682fdca2cdd7d23) | [file](https://github.com/Awake999/awake/blob/claude/new-session-1ofk4w/ops/data/BOOKING_ROSTER_AUDIT.md) |
| Meta Ads Verified Pull ($14,897.57) | [open](https://app.notion.com/p/3cc5bb1ffef4819ebfa1f800a8784d81) | [file](https://github.com/Awake999/awake/blob/claude/new-session-1ofk4w/ops/data/META_ADS_FULL_PULL.md) |
| Team Review Evidence Base | [open](https://app.notion.com/p/3cc5bb1ffef48180ad95f5d2592f917f) | [file](https://github.com/Awake999/awake/blob/claude/new-session-1ofk4w/ops/data/CONTRACTOR_REVIEW_EVIDENCE.md) |
| Constantine show-rate mining | — | [file](https://github.com/Awake999/awake/blob/claude/new-session-1ofk4w/ops/data/CONSTANTINE_SHOWRATE_MINING.md) |
| GHL ground truth (raw + derived, 8/30) | — | [folder](https://github.com/Awake999/awake/tree/claude/new-session-1ofk4w/ops/archive/ghl/2026-08-30) · [summary](https://github.com/Awake999/awake/blob/claude/new-session-1ofk4w/ops/archive/ghl/2026-08-30/GHL_PULL_SUMMARY.md) · [roster reconciliation](https://github.com/Awake999/awake/blob/claude/new-session-1ofk4w/ops/archive/ghl/2026-08-30/ROSTER_RECONCILIATION.md) |

## Decisions, SOPs, lanes
| What | Open it |
|---|---|
| DECISION: One-Place Architecture (needs Alan's sign-off) | [open](https://app.notion.com/p/3cc5bb1ffef481b38b04f5dac2e5e14a) |
...
| GHL location (Prismatic) | [open contacts](https://app.gohighlevel.com/v2/location/WFkoNzKa9J9PxhngsLfl/contacts/smart_list/All) |

## Drive (pre-vault docs)
