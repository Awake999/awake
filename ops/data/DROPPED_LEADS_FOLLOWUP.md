...
## 🔧 Method & honesty note
Built from the **Aug 30, 2026** GHL export ([raw data](https://github.com/Awake999/awake/tree/claude/new-session-1ofk4w/ops/archive/ghl/2026-08-30)) using `ops/tools/dropped_leads.py` plus the appointments, opportunities, speed-to-lead and derived-triage tables; Slack #----urgent and #sales-team-chat (Sep 3–4) supplied the post-export names. **I do not have a live GHL pull past Aug 30 from this environment** — running `ops/lane4/APW-PULL-ALL.bat` on the PC refreshes everything to the hour. Speed-to-lead minutes could not be computed reliably: most rows have no first-outbound timestamp *because no outbound exists*, which is category 1, not a timing problem. Alan's "Stefan Greco" is **Stephen Greco**.
